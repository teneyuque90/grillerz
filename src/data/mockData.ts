...
import { getLocalAvatarUriByChef, getLocalCoverUriByChef, getLocalGalleryUriByChef } from './localMedia';
...
export const mockChefs: Chef[] = [
  {
    ...
    coverUrl: getLocalCoverUriByChef('erick-martinez'),
    gallery: [0, 1, 2].map((index) => getLocalGalleryUriByChef('erick-martinez', index)),
  ...
  },
  {
    ...
    avatarUrl: getLocalAvatarUriByChef('carlos-bbq'),
    coverUrl: getLocalCoverUriByChef('carlos-bbq'),
    gallery: [0, 1, 2].map((index) => getLocalGalleryUriByChef('carlos-bbq', index)),
  ...
  },
  {
    ...
    avatarUrl: getLocalAvatarUriByChef('martin-asador'),
    coverUrl: getLocalCoverUriByChef('martin-asador'),
    gallery: [0, 1, 2].map((index) => getLocalGalleryUriByChef('martin-asador', index)),
  ...
  },
  {
    ...
    avatarUrl: getLocalAvatarUriByChef('luis-bbq'),
    coverUrl: getLocalCoverUriByChef('luis-bbq'),
    gallery: [0, 1, 2].map((index) => getLocalGalleryUriByChef('luis-bbq', index)),
  ...
  },
  {
    ...
    avatarUrl: getLocalAvatarUriByChef('cories-bbq'),
    coverUrl: getLocalCoverUriByChef('cories-bbq'),
    gallery: [0, 1, 2].map((index) => getLocalGalleryUriByChef('cories-bbq', index)),
